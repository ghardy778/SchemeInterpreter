...
namespace Tree
{
    public class Node : INode
    {
        ...
        {
            Console.Error.WriteLine("Error: Node is not builtin or closure");
            return Nil.getInstance();
        }
        ...
        /**
         * This function is only overwritten in the Cons class
         * */
        public virtual Boolean isEqual(Node exp)
        {
            return false;
        }
